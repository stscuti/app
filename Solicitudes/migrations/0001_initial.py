    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_expediente', models.ForeignKey(help_text='Numero de Expediente', on_delete=django.db.models.deletion.CASCADE, to='Solicitudes.Solicitud143_Step1', verbose_name='Numero de Expediente')),
            ],
            options={
                'verbose_name': 'Solicitud143_Step1',
                'verbose_name_plural': 'Solicitud143_Step1',
